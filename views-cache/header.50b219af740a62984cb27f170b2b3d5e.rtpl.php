...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                ...
                <ul class="sidenav-second-level collapse" id="collapseComponents">
                    <li>
                        <a href="res/aluno/navbar.html">Navbar</a>
                    </li>
                    <li>
                        <a href="res/aluno/cards.html">Cards</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
                ...
                <ul class="sidenav-second-level collapse" id="collapseExamplePages">
                    <li>
                        <a href="res/aluno/login.html">Login Page</a>
                    </li>
                    <li>
                        <a href="res/aluno/register.html">Registration Page</a>
                    </li>
                    <li>
                        <a href="res/aluno/forgot-password.html">Forgot Password Page</a>
                    </li>
                    <li>
                        <a href="res/aluno/blank.html">Blank Page</a>
                    </li>
                </ul>
            </li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a href="/spartacus/std/logout" class="nav-link">
